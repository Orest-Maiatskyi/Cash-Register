...
<link href="../../static/css/cashier/add-good-to-order.css" rel="stylesheet" type="text/css" />
...
<form action="#" class="acrylic shadow action-form cashier-form add-good-form">
    ...
    <div class="form-group">
        ...
        <input id="cashierOrderId" list="cashierOrderList" value="" class="custom-select">
        <datalist id="cashierOrderList"></datalist>
    </div>
    ...
    <div class="form-group">
        ...
        <input id="cashierGoodCode" list="cashierGoodList" value="" class="custom-select">
        <datalist id="cashierGoodList"></datalist>
    </div>
    ...
    <div class="form-group">
            ...
            <input id="cashierGoodTitle" list="cashierGoodTitleList" value="" class="custom-select">
            <datalist id="cashierGoodTitleList"></datalist>
    </div>
    ...
    <div class="form-group">
        ...
        <input id="cashierGoodQuantity" type="text" class="form-control d-inline" style="width: calc(100% - 60px);">
        <input class="btn btn-outline-secondary float-right" style="width: 50px;" type="button" value="PC" id="cashierMeasurementBox" disabled>
    </div>

    <div id="cashierAddGoodBtn" type="button" class="btn btn-primary" value="Add Good">
...
<script src="../../../static/js/ajax/cashier/addGoodToOrderAjax.js"></script>